...
new_data_path = r'E:\yanyi\code of paper\Self-MM-main\Self-MM-main\Dataset\MOSI\Processed\unaligned_50.pkl'
save_data_path = r'E:\yanyi\code of paper\Self-MM-main\Self-MM-main\Dataset\MOSI\unaligned_new.pkl'
...
data1 = {
    'train_new': data['train_new'],
    'valid_new': data['valid_new'],
    'test_new': data['test_new']
}
